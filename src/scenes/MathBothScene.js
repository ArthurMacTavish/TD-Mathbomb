...
export default class MathBombScene extends
    ...
    preload() {
        ...
        this.load.image('Player', 'assets/img/PlayerEngineer.png')

        this.load.spritesheet('Keypad', 'assets/img/KeyPad.png', {
            frameWidth: 131,
            frameHeight: 71.25
        })
        this.load.spritesheet('Bomb', 'assets/img/BombPulse.png', {
            frameWidth: 480,
            frameHeight: 480
        })
        this.load.spritesheet('Health', 'assets/img/HealthMetre.png', {
            frameWidth: 375,
            frameHeight: 1090
        })

        this.load.audio('BGMGame', 'assets/aud/Music.mp3')
    }
    create() {
        // BTD5 Music
